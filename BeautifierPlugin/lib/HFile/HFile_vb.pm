...
sub new
{
	...
	$self->{indent}	= ["Public Sub","Private Sub","Sub","Public Class","Private Class","Public Module","Try","Public Function","Private Function","Function","With","Select","If","For "];
	$self->{unindent}	= ["End Sub","End Class","End Module","End Try","End Function","End Select","End With","End If","Next","EndIf","exit"];
