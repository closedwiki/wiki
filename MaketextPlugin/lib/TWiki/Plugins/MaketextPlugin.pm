...
# are liste the AUTHORS file in the root of this distribution.
...
---+ package MaketextPlugin

=cut

package TWiki::Plugins::MaketextPlugin;
...
sub initPlugin {
    ...
    # register the _MAKETEXT function to handle %MAKETEXT{...}%
    TWiki::Func::registerTagHandler( 'MAKETEXT', \&_MAKETEXT );

    # Plugin correctly initialized
    return 1;
}

# The function used to handle the %MAKETEXT{...}% variable
...
sub _MAKETEXT {
    ...
    # do the magic:
    my $result  =  $session->{i18n}->maketext($str, @args);
