...
sub _getTemplate {
    ...
    my $t;
    # SMELL: no way to do this through the Func interface without expanding
    # other variables in the template as well. Bah humbug.
    $t = TWiki::handleTmplP( $name );
    # This is the only option Func offers:
    # $t =
