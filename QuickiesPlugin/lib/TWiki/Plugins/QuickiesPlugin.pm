...
package TWiki::Plugins::QuickiesPlugin;
...
sub _ORIGINALAUTHOR {
    ...
    my ($date, $user, $rev, $comment) = TWiki::Func::getRevisionInfo($theWeb, $theTopic, "1");
