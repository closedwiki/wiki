...
---+ package TWiki::InfixParser::Node

Base class for node types generated by InfixParser. You don't *have* to use
...
Construct a new parse node (contract with InfixParser)
...
Construct a new terminal node (contract with InfixParser)
