...
{ package FormFieldListPluginBuild;

  @FormFieldListPluginBuild::ISA = ( "TWiki::Contrib::Build" );

  sub new {
    my $class = shift;
    return bless( $class->SUPER::new( "FormFieldListPlugin"), $class );
  }
...
$build = new FormFieldListPluginBuild();
