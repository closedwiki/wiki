...
sub set_up {
  my $this = shift;
  $this->{map} = new FormQueryPlugin::Map("
     string = \"String\",
     number = 99,
     date = \"3-Jul-1960\"");
  # date's a sunday!
  my $mother = new FormQueryPlugin::Map("who=Mother");
  $this->{map}->set("mother", $mother);
  my $gran = new FormQueryPlugin::Map("who=GrandMother");
...
sub test_empty {
  my $this = shift;
  my $search = new FormQueryPlugin::Search("");
...
sub test_badparse {
  my $this = shift;
  eval {  new FormQueryPlugin::Search("WITHIN_DAYS"); };
  $this->assert_not_null($@,$@);
  eval {  new FormQueryPlugin::Search("x WITHIN_DAYS 30"); };
  $this->assert_not_null($@,$@);
  eval {  new FormQueryPlugin::Search("z WITHIN_DAYS < 3"); };
  $this->assert_not_null($@,$@);
}

sub check {
  my ( $this, $s, $r ) = @_;
  my $search = new FormQueryPlugin::Search($s);
...
sub test_dateops2 {
  my $this = shift;
  FormQueryPlugin::Search::forceTime("30 jun 1960");#thursday
...
sub test_dateops3 {
  my $this = shift;
  FormQueryPlugin::Search::forceTime("3 jul 1960");
...
sub test_dateops4 {
  my $this = shift;
  FormQueryPlugin::Search::forceTime("4 jul 1960");
