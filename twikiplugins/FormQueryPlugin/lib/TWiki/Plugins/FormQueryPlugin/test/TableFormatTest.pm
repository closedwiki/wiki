...
sub test_1 {
  ...
  my $tf = new FormQueryPlugin::TableFormat(new TWiki::Contrib::Map("header=\"|*X*|*Y*|\" format=\"|\$X|\$Y|\" sort=\"X\""));

  my $data = new TWiki::Contrib::Array();
  $data->add(new TWiki::Contrib::Map("X=0 Y=0"));
  $data->add(new TWiki::Contrib::Map("X=0 Y=1"));
  $data->add(new TWiki::Contrib::Map("X=1 Y=0"));
  $data->add(new TWiki::Contrib::Map("X=1 Y=1"));
...
sub test_2 {
  ...
  my $tf = new FormQueryPlugin::TableFormat(new TWiki::Contrib::Map("header=\"|*X*|*Y*|\" format=\"|\$X|\$Y|\" sort=\"Y,X\""));
...
sub test_3numeric {
  ...
  my $data = new TWiki::Contrib::Array();
  $data->add(new TWiki::Contrib::Map("X=3 Y=0"));
  $data->add(new TWiki::Contrib::Map("X=20 Y=1"));
  $data->add(new TWiki::Contrib::Map("X=110 Y=0"));
  $data->add(new TWiki::Contrib::Map("X=005 Y=1"));
...
sub test_5 {
  ...
  my $tfi = new FormQueryPlugin::TableFormat(new TWiki::Contrib::Map("header=\"|*X*|*Y*|\" format=\"|\$X|\$Y|\" sort=\"Y,X\""));
  $tfi->addToCache("FF");
  my $tfa = new FormQueryPlugin::TableFormat(new TWiki::Contrib::Map("header=\"|*X*|*Y*|\" format=\"|\$X|\$Y|\" sort=\"X,Y\""));
  $tfa->addToCache("GG");
  my $tfo = new FormQueryPlugin::TableFormat(new TWiki::Contrib::Map("header=\"|*T1*|*T2*|\" format=\"|\$T1[format=FF]|\$T2[format=GG]|\""));

  my $datao = new TWiki::Contrib::Array();
  my $submap = new TWiki::Contrib::Map();
  $datao->add($submap);

  my $dataX = new TWiki::Contrib::Array();
  $dataX->add(new TWiki::Contrib::Map("X=0 Y=0"));
  $dataX->add(new TWiki::Contrib::Map("X=0 Y=1"));
  $dataX->add(new TWiki::Contrib::Map("X=1 Y=0"));
  $dataX->add(new TWiki::Contrib::Map("X=1 Y=1"));
  $submap->set( "T1", $dataX );

  my $dataY = new TWiki::Contrib::Array();
  $dataY->add(new TWiki::Contrib::Map("X=2 Y=2"));
  $dataY->add(new TWiki::Contrib::Map("X=2 Y=3"));
  $dataY->add(new TWiki::Contrib::Map("X=3 Y=2"));
  $dataY->add(new TWiki::Contrib::Map("X=3 Y=3"));
  $submap->set( "T2", $dataY );
