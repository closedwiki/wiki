...
{ package BehaviourContribBuild;

  @BehaviourContribBuild::ISA = ( "TWiki::Contrib::Build" );

  sub new {
    my $class = shift;
    return bless( $class->SUPER::new( "BehaviourContrib" ), $class );
  }
...
$build = new BehaviourContribBuild();
