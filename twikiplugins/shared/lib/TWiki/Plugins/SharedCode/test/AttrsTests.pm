...
{ package AttrsTests;
  ...
  sub test_isEmpty {
	...
	my $attrs = TWiki::Attrs->new(undef);
  ...
  sub test_unquoted {
	...
	my $attrs = TWiki::Attrs->new("var1=val1 var2= val2, var3 = 3 var4 =val4");
  ...
  sub test_doubleQuoted {
	...
	my $attrs = TWiki::Attrs->new("var1 =\"val 1\", var2= \"val 2\" \" default \" var3 = \" val 3 \"");
  ...
  sub test_toString {
	...
	my $attrs = TWiki::Attrs->new("a ='\"', b=\"'\" \"'\"");
	my $s = $attrs->toString();
	$attrs = TWiki::Attrs->new($attrs->toString());
	$this->assert_str_equals("\"", $attrs->remove("a"));
	$this->assert_str_equals("'", $attrs->remove("b"));
	$this->assert_str_equals("'", $attrs->remove("__default__"));
	$this->assert($attrs->isEmpty());
