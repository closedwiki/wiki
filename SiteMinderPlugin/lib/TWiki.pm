...
use vars qw(
        ...
        $logFilename $remoteUserFilename $Filename $wikiUsersTopicname
...
sub initializeRemoteUser
{
    ...
    writeDebug( "=RemoteUserx==== $userName" );
        return $remoteUser;
    }
    ...
    writeDebug( "=RemoteUser==== $userName" );
    return $remoteUser;
}
