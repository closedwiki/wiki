...
package TWiki::Contrib::SearchEngineKinoSearchAddOn::StringifyPlugins::DOCX;
...
if (__PACKAGE__->_programExists("docx2txt.pl")){
...
sub stringForFile {
    ...
    my $cmd = "docx2txt.pl '$filename' $tmp_file 2>/dev/null";
