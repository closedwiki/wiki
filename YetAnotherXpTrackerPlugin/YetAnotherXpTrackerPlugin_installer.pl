...
,{ name=>'TWiki::Plugins::ControlPlugin', type=>'perl',version=>'>=1.001',description=>'Required. Download and install from [[TWiki:Plugins/ControlPlugin][plugin library]].', trigger=>1 }
