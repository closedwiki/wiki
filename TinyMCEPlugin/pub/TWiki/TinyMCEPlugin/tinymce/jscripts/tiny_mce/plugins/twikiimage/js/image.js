var TWikiImageDialog = {
	...
	showPreviewImage : function(u, st) {
		...
		if (!st)
			tinyMCEPopup.dom.setHTML('prev', '<img id="previewImg" src="' + u + '" border="0" onload="TWikiImageDialog.updateImageData(this);" onerror="TWikiImageDialog.resetImageData();" />');
		else
			tinyMCEPopup.dom.setHTML('prev', '<img id="previewImg" src="' + u + '" border="0" onload="TWikiImageDialog.updateImageData(this, 1);" />');
	}
};
