...
### my ( $text, $web ) = @_;   # do not uncomment, use $_[0], $_[1] instead
    ...
    &TWiki::Func::writeDebug( "- TWikiDrawSvgPlugin::startRenderingHandler( $_[1].$topic )" ) if $debug;
...
#   &TWiki::Func::writeDebug( "- TWikiDrawSvgPlugin::outsidePREHandler( $web.$topic )" ) if $debug;
...
#   &TWiki::Func::writeDebug( "- TWikiDrawSvgPlugin::insidePREHandler( $web.$topic )" ) if $debug;
...
### my ( $text ) = @_;   # do not uncomment, use $_[0] instead
    ...
    &TWiki::Func::writeDebug( "- TWikiDrawSvgPlugin::endRenderingHandler( $web.$topic )" ) if $debug;
