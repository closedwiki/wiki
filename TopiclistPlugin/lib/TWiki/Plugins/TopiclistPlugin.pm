...
---+ package TopiclistPlugin

=cut

package TWiki::Plugins::TopiclistPlugin;
...
sub initPlugin {
    ...
    # register the _TOPICLIST function to handle %TOPICLIST{...}%
    TWiki::Func::registerTagHandler( 'TOPICLIST', \&_TOPICLIST );

    # Plugin correctly initialized
    return 1;
}

# The function used to handle the %TOPICLIST{...}% tag
