...
sub new {
    ...
    if (defined &TWiki::Sandbox::untaint) {
        $web = TWiki::Sandbox::untaint(
            $web, \&TWiki::Sandbox::validateWebName );
        $topic = TWiki::Sandbox::untaint(
            $topic, \&TWiki::Sandbox::validateTopicName );
    }
