...
my %syntax = ( SEARCH => {
		...
		order => {type=>'text', default=>'', DOCCO=>''},
		limit => {type=>'text', default=>'', DOCCO=>''},
		date => {type=>'text', default=>'', DOCCO=>''},
		reverse => {type=>'onoff', default=>'off', DOCCO=>''},
		casesensitive => {type=>'onoff', default=>'off', DOCCO=>''},
		bookview => {type=>'onoff', default=>'off', DOCCO=>''},
		nosummary => {type=>'onoff', default=>'off', DOCCO=>''},
		nosearch => {type=>'onoff', default=>'off', DOCCO=>''},
		noheader => {type=>'onoff', default=>'off', DOCCO=>''},
		nototal => {type=>'onoff', default=>'off', DOCCO=>''},
		zeroresults => {type=>'onoff', default=>'off', DOCCO=>''},
		noempty => {type=>'onoff', default=>'off', DOCCO=>''},
		header => {type=>'text', default=>'', DOCCO=>''},
		format => {type=>'text', default=>'', DOCCO=>''},
		expandvariables => {type=>'onoff', default=>'off', DOCCO=>''},
		multiple => {type=>'onoff', default=>'off', DOCCO=>''},
		nofinalnewline => {type=>'onoff', default=>'off', DOCCO=>''},
		seperator => {type=>'text', default=>'', DOCCO=>''}
		}
	);
