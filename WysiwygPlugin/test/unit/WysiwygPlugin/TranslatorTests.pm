...
XWYZ
      },
      {
          ...
          tml => <<'XYZ',
<verbatim>
<img width="392" alt="���.png" src="�&#65533;bleGr�\u017ed/PånKake/�\u0160�\u017eå.png" height="129" />
</verbatim>
XYZ
          html => <<'XWYZ',
<pre class="TMLverbatim"><br />&lt;img&nbsp;width="392"&nbsp;alt="���.png"&nbsp;src="�&amp;#65533;bleGr�\u017ed/PånKake/�\u0160�\u017eå.png"&nbsp;height="129"&nbsp;/&gt;<br /></pre>
XWYZ
      },
      {
          exec => $ROUNDTRIP,
