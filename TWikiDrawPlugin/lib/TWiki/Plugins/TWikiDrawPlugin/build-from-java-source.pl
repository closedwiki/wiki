...
#
# This builds the packages from scratch, including source.zip from
# the Java source. The ant tool and Java is required.
# (Use build.pl to build using existing source.zip)
