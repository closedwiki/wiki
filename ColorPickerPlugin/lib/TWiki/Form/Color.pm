...
# Copyright (C) 2010-2013 TWiki Contributors. All Rights Reserved.
...
HERE
    TWiki::Func::addToHEAD( 'COLORPICKERPLUGIN_'.$this->{name}, $head, 'COLORPICKERPLUGIN' );
...
#    $button .= CGI::image_button(
#        -name  => "img$this->{name}",
#        -src   => $TWiki::cfg{PubUrlPath} . '/'
#                . $TWiki::cfg{SystemWebName}
#                . '/ColorPickerPlugin/color_bg.gif',
#        -alt   => 'ColorPicker',
#        -align => 'middle',
