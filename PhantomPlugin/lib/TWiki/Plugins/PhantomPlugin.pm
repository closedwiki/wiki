...
#    &TWiki::Func::writeDebug( "- TWiki::Plugins::PhantomPlugin::startRenderingHandler( $_[1].$topic )" ) if $debug;
...
#   &TWiki::Func::writeDebug( "- PhantomPlugin::outsidePREHandler( $web.$topic )" ) if $debug;
...
#   &TWiki::Func::writeDebug( "- TWiki::Plugins::PhantomPlugin::insidePREHandler( $web.$topic )" ) if $debug;
...
#    &TWiki::Func::writeDebug( "- TWiki::Plugins::PhantomPlugin::endRenderingHandler( $web.$topic )" ) if $debug;
