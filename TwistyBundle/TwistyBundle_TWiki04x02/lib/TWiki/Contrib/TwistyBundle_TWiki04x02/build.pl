...
{ package TwistyBundle_TWiki04x02Build;

  @TwistyBundle_TWiki04x02Build::ISA = ( "TWiki::Contrib::Build" );

  sub new {
    my $class = shift;
    return bless( $class->SUPER::new( "TwistyBundle_TWiki04x02" ), $class );
  }
...
$build = new TwistyBundle_TWiki04x02Build();
